...
当前：6/183 个纳入范围的文件完整逐行解释；363/34147 行已解释。
...
| [tests/test_btype_evidence.py](../../tests/test_btype_evidence.py) | 97 | 0 | 待逐行讲解 |
...
| [tools/diagnose_btypes.py](../../tools/diagnose_btypes.py) | 167 | 0 | 待逐行讲解 |
