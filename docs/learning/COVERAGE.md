...
当前：6/163 个纳入范围的文件完整逐行解释；363/31043 行已解释。
...
| 文件 | 总行数 | 已解释 | 状态 |
|---|---:|---:|---|
| [.github/workflows/bridge-core-tests.yml](../../.github/workflows/bridge-core-tests.yml) | 106 | 0 | 待逐行讲解 |
...
| [tests/bridge-core-maintenance-boundaries.test.mjs](../../tests/bridge-core-maintenance-boundaries.test.mjs) | 128 | 0 | 待逐行讲解 |
...
| [tools/build_linked_extension.mjs](../../tools/build_linked_extension.mjs) | 144 | 0 | 待逐行讲解 |
...
| [tools/diagnose_linked_types.mjs](../../tools/diagnose_linked_types.mjs) | 90 | 0 | 待逐行讲解 |
