...
> **最新更新：新增可选HTTP+Chat公共文本回退实验，候选类型0条，本地Node143项通过。** 这不是原生富卡片复原，也没有完成扩展激活或Windows安装器。见[公共Chat回退说明](PORTABLE_CHAT_INTEGRATION.md)。原HTTP模式仍11条、合同模式14条；历史CI与新变体证据分开记录，产品仍NOT_READY。
