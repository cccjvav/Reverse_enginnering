...
> **2026-09-19 状态**：本文的 A/B 之争针对的是**内核 Bridge UI 用哪种方式重建**，
> 属于路线图最后一步。此后作者澄清真实目标是**拿回源码本身**，该决策因此被推后，
> 目前**尚未启动**，本文结论仍待验证。
>
> 另需注意：本文成文时载体能否自建尚属未知；现已实证**可以**
> （CI run `35371925282`，编译 0 错误）。这不改变 A/B 的取舍逻辑，但去掉了
> "载体也许根本建不起来"这个前提风险。
